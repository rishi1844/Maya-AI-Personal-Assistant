...
function takeCommand(command) {
    ...
    const commandMap = {
        ...
        "hello": () => displayMessageAndSpeak(`Hello ${currentUser}, What can I help you with?`),
        "hey": () => displayMessageAndSpeak(`Hello ${currentUser}, What can I help you with?`),
        "who are you": () => displayMessageAndSpeak("Hi, I am MAYA a super intelligent virtual assistant, created by Mr. Chirag Saini. To ease the life of human beings."),
        "what is your name": () => displayMessageAndSpeak("Hi, I am MAYA a super intelligent virtual assistant, created by Mr. Chirag Saini. To ease the life of human beings."),
        ...
        "tumhe kisane banaaya hai": () => speak("नमस्ते, मैं MAYA एक सुपर इंटेलिजेंट वर्चुअल असिस्टेंट हूं, जिसे श्रीमान चिराग सैनी जी ने बनाया है। मनुष्य के जीवन को आसान बनाने के लिए।"),
        "what's your name": () => speak("Hi, I am MAYA a super intelligent virtual assistant, created by Mr. Chirag Saini. To ease the life of human beings."),
        "birthday": () => displayMessageAndSpeak("6 February ko apka birthday hai"),
        "tum mujhe janti ho": () => displayMessageAndSpeak(`Aap mere malik ho, Apka Naam ${currentUser} hai.`),
        "main kaun hun": () => speak(`Aap mere malik ho, Apka Naam ${currentUser} hai.`),
        "do you know": () => speak("Ha, mai Janti hu. Aap mere Creater ho. Apka Naam Chirag hai."),
        "more about me": () => speak("Okey, aap 22 years ke ho. Aapka ghar Haryana ke Karnal Shahar me hai. Filhaal Aap Chandigarh University me padhte ho. Apka Interest Coding ur Pubg khelne me hai"),
        "mere bare me": () => speak("Okey, aap 22 years ke ho. Aapka ghar Haryana ke Karnal Shahar me hai. Filhaal Aap Chandigarh University me padhte ho. Apka Interest Coding aur Pubg khelne me hai"),
